...
<head>
    ...
    <style>
        /* Estilos específicos para la página de login (copiados de login.php) */
        .login-container {
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (forgotPasswordLink) {
                forgotPasswordLink.addEventListener('click', function(e) {
                    ...
                    if (modal) {
                        ...
                        // Asegurar que se muestre la sección de email
            ...
            if (recoveryForm) {
                recoveryForm.addEventListener('submit', async function(e) {
                    ...
                    try {
                        ...
                        const response = await fetch('php/auth/send_test_email.php', {
                            method: 'POST',
                            body: formData
                        });
            ...
            // Botón para volver a la sección de email
            ...
            // Manejador del formulario de validación de código
            ...
            if (codeForm) {
                codeForm.addEventListener('submit', async function(e) {
                    ...
                    const validateBtn = codeForm.querySelector('button[type="submit"]');
                    ...
                    try {
                        ...
                        const response = await fetch('php/auth/verify_recovery_code.php', {
                            method: 'POST',
                            body: formData
                        });
            ...
            // Botón para volver a la sección de código
            ...
            // Manejador del formulario de cambiar contraseña
