        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (codeForm) {
                codeForm.addEventListener('submit', async function(e) {
                    ...
                    // El código fijo es "342 405" sin espacios sería "342405"
                    const validCode = '342405';
                    const codeWithoutSpaces = code.replace(/\s/g, '');
                    
                    if (codeWithoutSpaces === validCode) {
                        alert('✓ Código validado correctamente. Tu contraseña ha sido restablecida.');
